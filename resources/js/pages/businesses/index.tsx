...
function RowActions({
    ...
    return (
        <div className="flex items-center justify-end gap-1.5">
            <CheckPermission
                permissions={[
                    UserPermission.EDIT_ANY_BUSINESS,
                    UserPermission.EDIT_OWN_BUSINESS,
                ]}
            >
            ...
            <CheckPermission
                permissions={[
                    UserPermission.DELETE_ANY_BUSINESS,
                    UserPermission.DELETE_OWN_BUSINESS,
                ]}
            >
            ...
            <div className="mx-auto max-w-7xl px-4 pt-4 pb-6 sm:px-6 md:pt-6 md:pb-8 lg:px-8">
                ...
                <ContentHeader
                    ...
                    actions={
                        <CheckPermission
                            permissions={[
                                UserPermission.CREATE_ANY_BUSINESS,
                                UserPermission.CREATE_OWN_BUSINESS,
                            ]}
                        >
                            <button
