...
export default function Create({ businesses = [], users = [], product_units = [], products = [] }: CreateProps) {
    const { props } = usePage();
            ...
            <div className="mx-auto max-w-5xl w-full px-4 py-6 sm:px-6 lg:px-8">
                ...
                <div className="rounded-2xl border border-slate-200 bg-white shadow-sm dark:border-slate-800 dark:bg-slate-900 overflow-hidden transition-all duration-300">
                    <div className="border-b border-slate-100 bg-slate-50/50 px-6 py-5 dark:border-slate-800 dark:bg-slate-900/50 flex items-center gap-3">
                        ...
                        <div>
                            <h2 className="text-lg font-bold text-slate-900 dark:text-white">Tambah Produk Penjualan</h2>
                            <p className="text-xs text-slate-500 dark:text-slate-400">Buat varian produk penjualan baru di bawah produk induk beserta satuan kemasan dan tier harga.</p>
                        </div>
                    </div>
                    ...
                    <form onSubmit={handleSubmit} className="p-6 space-y-6">
                        ...
                        {hasCreateAnyProductItem && !isFetchingBusinesses && selectedOwnerId && (
                            <FormSelect
                                name="business_id"
                                label="Pilih Bisnis"
                        ...
                        {(!hasCreateAnyProductItem || (hasCreateAnyProductItem && selectedBusinessId && !isFetchingProducts)) && (
                            <FormSelect
                                name="product_id"
